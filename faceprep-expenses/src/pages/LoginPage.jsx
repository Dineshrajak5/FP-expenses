  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        background: 'radial-gradient(circle, rgba(240,81,54,0.07) 0%, transparent 70%)',
        pointerEvents: 'none',
      }} />
      ...
      <div style={{ position: 'relative', width: '100%', maxWidth: 380 }}>
        ...
        <div className="card" style={{ padding: 30, borderRadius: 18, boxShadow: '0 12px 48px rgba(0,0,0,0.5)' }}>
          <h2 style={{ marginBottom: 5, fontSize: '1.1rem' }}>Welcome back</h2>
          <p style={{ fontSize: 13, marginBottom: 24, color: 'var(--text-muted)' }}>
            Sign in with your <span style={{ color: 'var(--brand)', fontFamily: 'var(--mono)' }}>@{ALLOWED_DOMAIN}</span> Google account
          </p>
          ...
          <button
            ...
            onClick={handleLogin}
            disabled={loading}
            style={{ width: '100%', justifyContent: 'center', padding: 12, fontSize: 14, gap: 11 }}
          >
            {loading ? <div className="spinner" style={{ width: 17, height: 17 }} /> : (
