...
function AppShell() {
  ...
  // When impersonating, redirect away from pages the impersonated role can't access
  const allowedPages = {
  ...
  const currentPage = allowedPages[role]?.includes(page) ? page : 'dashboard'
